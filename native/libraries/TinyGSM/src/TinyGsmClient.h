...
#elif defined(TINY_GSM_MODEM_M590_MOD)
  #define TINY_GSM_MODEM_HAS_GPRS
  #include <TinyGsmClientM590_Mod.h>
  typedef TinyGsmM590_Mod TinyGsm;
  typedef TinyGsmM590_Mod::GsmClient TinyGsmClient;


#elif defined(TINY_GSM_MODEM_N10_MOD)
  #define TINY_GSM_MODEM_HAS_GPRS
  #include <TinyGsmClientN10_Mod.h>
  typedef TinyGsmN10_Mod TinyGsm;
  typedef TinyGsmN10_Mod::GsmClient TinyGsmClient;
