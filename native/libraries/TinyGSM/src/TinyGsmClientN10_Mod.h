...
class TinyGsmN10_Mod{

public:
class GsmClient : public Client{
    friend class TinyGsmN10_Mod;

  public:
    GsmClient() {}
    GsmClient(TinyGsmN10_Mod& modem) {
      this->init(&modem);
    }

    bool init(TinyGsmN10_Mod* modem) {
...
private:
    bool  sock_connected;
    TinyGsmN10_Mod*  gsm_modem;
};

public:

#ifdef GSM_DEFAULT_STREAM
    TinyGsmN10_Mod(Stream& stream = GSM_DEFAULT_STREAM)
#else
    TinyGsmN10_Mod(Stream& stream)
#endif
    :_uart_stream(stream)
    {
